...
public class Group3 : MonoBehaviour
{
    ...
    public void SubmitChoice(string choice)
    {
        if(numChoice == 1 && choice == "Beef burger")
        {
            ...
            textBox.text = "Unfortunately, the <u>beef burger</u> is out of stock. We have a <u>bowl w/ black beans</u> instead.";
            priceTag1.text = "Bowl black beans\n\n€ 4,95,-";
        }
        ...
        if(numChoice == 1 && choice == "Chicken wrap")
        {
            ...
            eventTypeString = "Choice 1";
            eventTypeString2 = "Start Choice 2";
            textBox.text = "Unfortunately, the <u>chicken wrap</u> is out of stock. We have a <u>bowl w/ chickpeas</u> instead.";
            priceTag2.text = "Bowl chickpeas\n\n€ 4,95,-";
        }

        if(numChoice == 2 && choice == "Bowl black beans")
        {
            mainFile.itemChosen = "Bowl black beans";
            mainFile.itemLeft = "Bowl black beans";
            mainFile.itemRight = "Chicken wrap";
            mainFile.sideItemChosen = "Left";
        ...
        if(numChoice == 2 && choice == "Bowl chickpeas")
        {
            mainFile.itemChosen = "Bowl chickpeas";
            mainFile.itemLeft = "Beef burger";
            mainFile.itemRight = "Bowl chickpeas";
            mainFile.sideItemChosen = "Right";
            eventTypeString = "Choice 2";
            eventTypeString2 = "Start Choice 3";
            textBox.text = "Great choice! Please proceed to checkout.";
        ...
        if(numChoice == 3 && choice == "Bowl chickpeas")
        {
            mainFile.itemChosen = "Bowl chickpeas";
            mainFile.itemLeft = "Bowl black beans";
            mainFile.itemRight = "Bowl chickpeas";
        ...
        if(numChoice == 3 && choice == "Bowl black beans")
        {
            mainFile.itemChosen = "Bowl black beans";
            mainFile.itemLeft = "Bowl black beans";
            mainFile.itemRight = "Bowl chickpeas";
        ...
        if(numChoice == 4 && choice == "Bowl chickpeas")
        {
            mainFile.itemChosen = "Bowl chickpeas";
            mainFile.itemLeft = "Bowl black beans";
            mainFile.itemRight = "Bowl chickpeas";
        ...
        if(numChoice == 4 && choice == "Bowl black beans")
        {
            mainFile.itemChosen = "Bowl black beans";
            mainFile.itemLeft = "Bowl black beans";
            mainFile.itemRight = "Bowl chickpeas";
